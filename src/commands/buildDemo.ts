...
async function ensureDataverseMcpConfig(root: string): Promise<void> {
  ...
  vscode.window.showInformationMessage(
    `CPSAgentKit: Dataverse MCP Server configured → ${mcpUrl}`,
  );
}
...
function composeDemoWalkthrough(
  ...
  const sections = [
    ...
    "---",
    "",
    "## Step 2: Generate Spec and Architecture",
    "",
    "Tell the user to:",
    ...
    "---",
    "",
    "## Step 4: Create Agents in Copilot Studio Portal",
    "",
    "Tell the user to create these agents in the Copilot Studio portal:",
    "",
    "### 4a. Parent Agent — IT Help Desk Orchestrator",
    ...
    "",
    "### 4b. Child Agent — Knowledge Specialist",
    ...
    articleList,
    "",
    "### 4c. Child Agent — Notification Specialist",
    ...
    "---",
    "",
    "## Step 5: Clone and Sync Agent YAML Locally",
    "",
    "Tell the user to:",
    "1. Open the Command Palette",
    ...
    "---",
    "",
    "## Step 6: Build Agent Configuration",
    "",
    "Tell the user to:",
    "1. Open the Command Palette",
    ...
    "---",
    "",
    "## Step 7: Apply Changes to Portal",
    "",
    "Tell the user to:",
    ...
    "---",
    "",
    "## Step 8: Configure Portal-Only Settings",
    "",
