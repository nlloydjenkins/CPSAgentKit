...
function composeApplicationIntakeWalkthrough(
  ...
  const sections = [
    ...
    "## Step 6: Create Agents in Copilot Studio Portal",
    "",
    "Tell the user to create agent shells and connections in the portal. The **Build Agent** command (Step 10) generates all instructions, descriptions, and tool configurations — they only need to set up the structure here.",
    "",
    ...
    "6. Set content moderation to **Low** (Settings → Generative AI)",
    "",
    "### 6b. Add Tools to Parent",
    "All tools must be on the parent agent (child agents are tool-less):",
    "",
    "1. **Microsoft Dataverse — List rows from selected environment**",
    ...
    "3. **Microsoft Dataverse — Update a row in selected environment**",
    "4. **Office 365 Outlook — Get email (V3)**",
    "5. **Office 365 Outlook — Send an email from a shared mailbox (V2)**",
    "6. **Microsoft Teams — Post adaptive card and wait for a response**",
    "",
    ...
    "1. Create a new prompt tool named **Attachment Preprocessor**",
    "2. Enable code interpreter",
    "3. Input: attachment content + case context",
    "4. Output: normalised text/Markdown",
    "",
    "### 6d. Create 5 Child Agents",
    "Create each as a child agent with just a name and knowledge source — no descriptions or instructions needed yet:",
    "",
    ...
    "",
    "Knowledge source files in the workspace:",
    sourceList,
    "",
    "---",
    "",
