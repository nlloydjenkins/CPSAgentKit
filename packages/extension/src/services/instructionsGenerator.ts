...
function buildProjectStateSection(state: ProjectState): string {
  ...
  const lines: string[] = [
    "## Current CPSAgentKit Project State",
    "",
    "This section describes the developer's installed and initialised CPSAgentKit workspace, not the CPSAgentKit tool source repository.",
    "",
    `- **Current phase:** ${phase}`,
    ...
    `- **Best practices:** ${state.hasBestPractices ? ".cpsagentkit/bestpractices/ exists" : "no synced best practices"}`,
  ];
...
export async function generateInstructions(
  ...
  const parts = [
    "<!-- AUTO-GENERATED by CPSAgentKit for this Copilot Studio workspace. Do not edit manually. Regenerated on every knowledge sync. -->",
    "",
    template,
  ];
