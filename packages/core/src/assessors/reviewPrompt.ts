/**
 * Compose the CPS review prompt — pure text composition from AgentSnapshots,
 * knowledge rules, requirements docs, and best practices.
 */
import { CORE_VERSION } from "../version.js";
import type { AgentSnapshot } from "../parsers/agentSnapshot.js";
import { isTemplateOnly } from "../parsers/markdown.js";
import {
